...
knitr::include_graphics(c("Image1.jpg", "Image2.jpg"))
``` 
...
```{r image_osteoporosis_2, fig.show = "hold", out.width = "80%", fig.align = "center"}
...
## Individualized approaches
```{r smooth, fig.show = "hold", out.width = "90%", fig.align = "center"}
